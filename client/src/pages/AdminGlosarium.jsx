...
const AdminGlosarium = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/halaman_glosarium/${formData.id}`, {
                method: 'PUT',
                headers: {
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen flex justify-center items-center">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-2xl">
                <h2 className="text-2xl font-bold mb-4">Edit Halaman Glosarium</h2>
